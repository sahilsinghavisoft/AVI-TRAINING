...
*/
CREATE TABLE locations(location_id INT PRIMARY KEY,street_address VARCHAR(255),postal_code VARCHAR(20),city VARCHAR(100),
state_province VARCHAR(100),country_id VARCHAR(2));
...
(2700, 'Schwanthalerstr. 703', '80925', 'Munich', 'Bavaria', 'DE'),
(2800, 'Rua Frei Caneca 1360', '01307-002', 'Sao Paulo', 'Sao Paulo', 'BR'),
(2900, '20 Rue des Corps-Sains', '1730', 'Geneva', 'Geneve', 'CH'),
(3000, 'Murtenstrasse 921', '3095', 'Bern', 'BE', 'CH'),
(3100, 'Pieter Breughelstraat', '3029SK', 'Utrecht', 'Utrecht', 'NL'),
(3200, 'Mariano Escobedo 999', '11932', 'Mexico City', 'Distrito Federal', 'MX');
select *from locations;
CREATE TABLE countries(country_id VARCHAR(2),country_name VARCHAR(255),region_id INT);
...
CREATE TABLE new_employees (EMPLOYEE_ID INT,FIRST_NAME VARCHAR(50),LAST_NAME VARCHAR(50),EMAIL VARCHAR(50),
...
(176, 'Jonathon', 'Taylor', 'JTAYLOR', '011.44.1644.429265', '1987-09-01', 'SA_REP', 8600.00, 0.25, 149, 80),
(177, 'Jack', 'Livingston', 'JLIVINGS', '011.44.1644.429264', '1987-09-02', 'SA_REP', 8400.00, 0.25, 149, 80),
...
CREATE TABLE departments (DEPARTMENT_ID INT PRIMARY KEY,DEPARTMENT_NAME VARCHAR(50),MANAGER_ID INT,LOCATION_ID INT);
...
SELECT e.FIRST_NAME, e.LAST_NAME, e.DEPARTMENT_ID, d.DEPARTMENT_NAME FROM new_employees e 
...
*/
SELECT e.FIRST_NAME,e.LAST_NAME,e.JOB_ID,e.DEPARTMENT_ID, d.DEPARTMENT_NAME FROM new_employees e
